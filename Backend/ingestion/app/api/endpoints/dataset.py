from fastapi import APIRouter, Depends, File, Request, UploadFile, Query, HTTPException, Form
...
def getZones(
    ...
    zones, total = datasetRepo.getZones(
        datasetId=datasetId, search=search, limit=limit, offset=offset, department=department
    )
    ...
    return {
        ...
        "offset": offset,
        "items": [
            {"zoneCode": z.zoneCode, "zoneName": z.zoneName, "department": z.department}
            for z in zones
        ],
    }
